...
class SkillConsumer(gl.contract.Contract):
 aI: Address
 F: Address
 aa: gl.storage.TreeMap[u32, Bounty]
 B: gl.storage.DynArray[u32]
 V: u32
 aq: gl.storage.TreeMap[str, gl.storage.DynArray[u32]]
 aB: gl.storage.TreeMap[Address, gl.storage.DynArray[u32]]
 C: u128
 I: u128
 r: u128
 s: u128
 ...
 def __init__(self, F: str):
  ...
  self.k = u128(0)
 def aG(self) -> int:
  return ae(gl.message.raw.get("datetime", ""))
