...
class SkillVerify(gl.Contract):
 O: Address
 aT: bool
 ab: TreeMap[u32, Verification]
 bG: DynArray[u32]
 aU: u32
 cS: TreeMap[str, DynArray[u32]]
 cy: TreeMap[str, DynArray[u32]]
 cq: TreeMap[str, DynArray[u32]]
 al: TreeMap[str, u32]
 bH: TreeMap[str, u32]
 bQ: TreeMap[str, Address]
 aq: TreeMap[str, u64]
 aM: TreeMap[Address, u64]
 aV: u128
 T: u64
 u: u64
 C: u64
 ...
 def __init__(self, aV: int = bA):
  ...
  self.X = u128(0)
 def cb(self) -> int:
  return bL(gl.message_raw.get("datetime", ""))
